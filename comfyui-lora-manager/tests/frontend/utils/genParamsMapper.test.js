...
describe('resolveSamplerScheduler', () => {
    ...
    it('splits an internal-looking sampler and scheduler pair', () => {
        expect(resolveSamplerScheduler('dpmpp_2m_beta')).toEqual({
            sampler: 'dpmpp_2m',
            scheduler: 'beta',
        });
    });

    it('repairs the legacy dpmpp_2_ancestral alias', () => {
        expect(resolveSamplerScheduler('dpmpp_2_ancestral')).toEqual({
