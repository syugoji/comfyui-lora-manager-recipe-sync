...
export const state = {
    ...
    pages: {
        ...
        recipes: {
            ...
            pageSize: 20,
            showFavoritesOnly: false,
            favoriteFilter: getStorageItem('recipes_favorite_filter', 'all'),
            replayCapabilityFilter: getStorageItem('recipes_replay_capability_filter', 'all'),
            promptStatusFilter: getStorageItem('recipes_prompt_status_filter', 'all'),
            duplicatesMode: false,
            bulkMode: false,
