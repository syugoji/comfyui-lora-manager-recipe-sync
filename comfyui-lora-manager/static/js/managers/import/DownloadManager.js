...
import { buildCompleteRecipeMetadata } from '../../utils/recipeMetadata.js';
    ...
    async saveRecipe(skipDownload = false) {
        ...
        try {
            ...
            if (!isDownloadOnly) {
                ...
                const urlInput = document.getElementById('imageUrlInput');
                const sourcePath = this.importManager.importMode === 'url'
                    ? urlInput?.value
                    : null;
                const completeMetadata = buildCompleteRecipeMetadata(
                    this.importManager.recipeData,
                    sourcePath,
                );
