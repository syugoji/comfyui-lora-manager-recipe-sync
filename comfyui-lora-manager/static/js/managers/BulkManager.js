...
export class BulkManager {
    constructor() {
        ...
        this.recipeResourceDownloadBtn = document.getElementById('downloadMissingRecipeResourcesBtn');
    ...
    toggleBulkMode() {
        ...
        this.updateRecipeResourceDownloadButton();
    }
    ...
    updateRecipeResourceDownloadButton() {
        if (!this.recipeResourceDownloadBtn) return;
        const canDownload = state.currentPageType === 'recipes'
            && state.bulkMode
            && state.selectedModels.size > 0;
        this.recipeResourceDownloadBtn.disabled = !canDownload;
    }
