...
class BaseRecipeRoutes:
    ...
    def _create_handler_set(self) -> RecipeHandlerSet:
        ...
        lora_scanner_getter = lambda: self.lora_scanner
        ...
        prompt_draft_service = RecipePromptDraftService(
            replay_manifest_service=replay_manifest_service,
            logger=logger,
            civitai_client_getter=civitai_client_getter,
            downloader_factory=get_downloader,
            lora_scanner_getter=lora_scanner_getter,
            cache_dir=os.path.join(get_cache_base_dir(), "prompt_drafts"),
        )
        ...
        listing = RecipeListingHandler(
            ...
            recipe_scanner_getter=recipe_scanner_getter,
            replay_manifest_service=replay_manifest_service,
            prompt_draft_service=prompt_draft_service,
